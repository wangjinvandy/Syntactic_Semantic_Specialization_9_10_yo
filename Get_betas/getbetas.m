...
addpath('/dors/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp/toolbox');
marsbar('on');
...
rootDIR  = '/dors/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/PlausGram_9-10/preproc';
...
roi_file_root = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/PlausGram_9-10/scripts/roi/';
...
% set parameters
namerois = {'combined_4ROIs'}; %put the name of the roi files here, omitting the '_rot.mat' part
...
%subject)
nameconditions={'Sn(1) G_C'  'Sn(1) G_F'  'Sn(1) G_G'  'Sn(1) G_P'  ...
                'Sn(2) G_C'  'Sn(2) G_F'  'Sn(2) G_G'  'Sn(2) G_P'  ...
                'Sn(3) SP_C'  'Sn(3) SP_I'  'Sn(3) SP_S'  'Sn(3) SP_W'  ...
                'Sn(4) SP_C'  'Sn(4) SP_I'  'Sn(4) SP_S'  'Sn(4) SP_W'};

%These entries correspond to the condition names in nameconditions. I'd like to use these for column headings.
friendlyconditions=	{'G_C1' 'G_F1' 'G_G1' 'G_P1' ...
    'G_C2' 'G_F2' 'G_G2' 'G_P2' ...
    'SP_C1' 'SP_I1' 'SP_S1' 'SP_W1' ...
    'SP_C2' 'SP_I2' 'SP_S2' 'SP_W2' };
